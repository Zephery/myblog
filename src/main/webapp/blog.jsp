            ...
            <td colspan="9" align="center" class="p">
                <c:if test="${pageNum != 1}">
                    <button class="btn btn-default btn-sm"
                            onclick="location.href='blog.html?pagenum=1&categoryid=${categoryid}'"
                            style="background: transparent;">首页
                    </button>
                    <button class="btn btn-default btn-sm"
                            onclick="location.href='blog.html?pagenum=${pageNum - 1}&categoryid=${categoryid}'"
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <button class="btn btn-default btn-sm,active"
                                        onclick="location.href='blog.html?pagenum=${pageIndex}&categoryid=${categoryid}'">${pageIndex}</button>
                            </c:otherwise>
                        </c:choose>
                    </c:forEach>
                </c:if>
