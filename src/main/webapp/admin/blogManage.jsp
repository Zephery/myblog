...
//            console.log(row.blogid);
            window.parent.openTab('修改博客','modifyBlog.html?blogid='+row.blogid,'icon-writeblog');
        }
...
<table id="dg" title="博客管理" class="easyui-datagrid"
       ...
       url="${pageContext.request.contextPath}/admin/bloglist.html" fit="true" toolbar="#tb">
    <thead>
    <tr>
        <th field="cb" checkbox="true" align="center"></th>
        <th field="blogid" width="20" align="center">编号</th>
        <th field="title" width="200" align="center">标题</th>
        <th field="datetime" width="50" align="center">发布日期</th>
