...
<head>
    ...
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/static/html2markdown/markdown_dom_parser.js"></script>
    <script type="text/javascript"
            src="${pageContext.request.contextPath}/static/html2markdown/html2markdown.js"></script>
    <script type="text/javascript">
        $(function () {
