                        ...
                        if (itemNum > 30) {
                            ...
                            for (var i in sqlJson) {
                                html += "<li class='item'><a href='####' class='a-img'>" +
                                        "<img src='" + sqlJson[i].src + "' style='width: 94%'></a>";
...
<div class="content">
    ...
    <div class="waterfull clearfloat" id="waterfull">
        <ul>
            ...
            <li class="item">
                <a href="####" class="a-img">
                    <img src="./images/t8.jpg" alt="" style="width: 94%">

                </a>
                <p class="description" style="height: auto">HTML 许直接跨域通
            ...
            <li class="item">
                <a href="####" class="a-img">
                    <img src="./images/t7.jpg" alt="" style="width: 94%">

                </a>
                <p class="description" style="height: auto">HTML 5以前的标...</p>
                <div class="qianm clearfloat">
                    <span class="sp1"><b>688</b>浏览</span>
                    <span class="sp2">志强不息</span>
                    <span class="sp3">2小时前&nbsp;By</span>
            ...
            <li class="item">
                <a href="####" class="a-img">
                    <img src="./images/t9.jpg" alt="" style="width: 94%">

                </a>

                <p class="description" style="height: auto">HTML 5以前的标准由，于...</p>
                <div class="qianm clearfloat">
                    <span class="sp1"><b>688</b>浏览</span>
                    <span class="sp2">志强不息</span>
                    <span class="sp3">2小时前&nbsp;By</span>
            ...
            <li class="item">
                <a href="####" class="a-img">
                    <img src="./images/t3.jpg" alt="" style="width: 94%">

                </a>

                <p class="description" style="height: auto">HTML 5以前的标准由于考虑到浏.</p>
                <div class="qianm clearfloat">
                    <span class="sp1"><b>688</b>浏览</span>
                    <span class="sp2">志强不息</span>
                    <span class="sp3">2小时前&nbsp;By</span>
    ...
    <!-- loading按钮自己通过样式调整 -->
    <div id="imloading"
         style="width:150px;height:30px;line-height:30px;font-size:16px;text-align:center;
         border-radius:3px;opacity:0.7;background:#000;margin:10px auto 30px;color:#fff;display:none">
        I'm Loading.....
    </div>
</div>
</body>
